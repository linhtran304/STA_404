...
pacman::p_load(flexdashboard, tidyverse, plotly, magrittr, shiny, bslib, DT)
...
load(url("https://github.com/linhtran304/STA_404/raw/main/fullDashboard/processed_allData_final.RData"))
```
  ...
  plot_cor = plot_cor +
      labs(y = "Number of Downloads in the Last 30 Days",
           ...
           title = str_c("Sentiment vs. Popularity for",
                         input$bookshelf, sep=" "))  + 
      theme(legend.position = "none", axis.title.y = element_text(color = "grey50"),axis.title.x = element_text(color = "grey50"),plot.subtitle = element_text(color = "grey50"))
...
sentiment <- reactive({
  data |> 
    filter(author == input$authorSearch) |> 
    select(gutenberg_id, title, author, index,bing_positive, bing_negative, bing_overall, downloads_30_days ) |> 
    distinct() |> 
...
renderPlotly({
  sentiment_plot = ggplot(sentiment(), 
        ...
        theme(legend.position = 'none', 
              axis.title.y = element_text(color = "grey50"),axis.title.x = element_text(color = "grey50")) 
